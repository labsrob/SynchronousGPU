...
def localSplash():
	...
	if not splashInUse:
		...
		if scrRes == '4k':
			...
			Label(mySplash, text="Advanced Statistical Processing & Visualization System", justify=CENTER).place(x=78,
																												 y=150)
			Label(mySplash, text="Integrated into SCADA's (CF/PEEK) Manufacturing Process", justify=CENTER).place(x=70,
																												  y=168)
			...
			Label(mySplash, text="Advanced Statistical Processing & Visualization System", justify=CENTER).place(x=65,
																												 y=150)
			Label(mySplash, text="Integrated into SCADA's (CF/PEEK) Manufacturing Process", justify=CENTER).place(x=55,
																												  y=168)
