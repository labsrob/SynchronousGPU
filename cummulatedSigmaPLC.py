...
def sigmaErrorLog(layer, pID, pX, pD, pU, pL, rID, v1, v2, v3, v4, pPos):
    rtitle = ('============================ TCP01 FMEA Layered Reports ===============================================\n')
    rheader = ('Time'+'\t\t'+'Layer#'+'\t'+'pID'+'\t'+'pMean'+'\t'+'pDev'+'\t'+'UCL'+'\t'+'LCL'+'\t'+'RingID'+'\t'+'Head1'+'\t'+'Head2'+'\t'+'Head3'+'\t'+'Head4'+'\t'+'EstPos'+'\n')
    rdemaca = ("------------------------------------------------------------------------------------------------------\n")
    fileName = datetime.now().strftime('FM_Repo '+WON_Array)
...
def processR3_Sigma(pU, pL, pX, pD, v1, v2, v3, v4, clayer, pPos, pID, md, WN):
    """
...
def processR4_Sigma(pU, pL, pX, pD, v1, v2, v3, v4, clayer, pPos, pID, md, WN):
    """
