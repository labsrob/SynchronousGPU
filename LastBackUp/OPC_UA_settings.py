...
def load_configPLC(configFile):
    config_object.read(configFile)
    PLC = config_object["3e2e29372a3f24243c2720233c"]

    id = PLC['27120b16210c1f04']
    ky = PLC['390417323d081407']
    db = PLC['213022000d3f1707']
    tcp = PLC["2130222a0a193b25"]
...
def writePLCconfig(a, b, c, d):
    ...
    with open("ISO62264_ISA95.ini", 'w') as configfile:
