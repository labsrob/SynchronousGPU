...
def loadProcesValues(df1, prod):        # Load useful columns out of many
    if prod == 'DNV':
        ...
        sqlPM = [ df1['cTensX'], # numpy=0 cupy=#1
                   df1['oTempA'], df1['oTempB'],
                   df1['iTempA'], df1['iTempB'],
                   df1['iTempC'], df1['iTempD'], #6
                   df1['wSpedA'], df1['wSpedB'],
                   df1['wSpedC'], df1['wSpedD'], #10/11
                   df1['cLayer'], #11
                   # ------ Roller Pressure ----[T2/T3]
                   df1['cLayer'], df1['R1H1RP'], #13/14
                   df1['R1H2RP'], df1['R1H3RP'], df1['R1H4RP'],
                   df1['R2H1RP'], df1['R2H2RP'], df1['R2H3RP'],
                   df1['R2H4RP'], #20
                   df1['cLayer'],
                   df1['R3H1RP'], df1['R3H2RP'], df1['R3H3RP'], #24
                   df1['R3H4RP'], df1['R4H1RP'], df1['R4H2RP'],
                   df1['R4H3RP'], df1['R4H4RP']] #29

    elif prod == 'MGM':
        sqlPM = [df1['cTensX'],
                 df1['oTempA'], df1['oTempB'],
                 df1['iTempA'], df1['iTempB'],
                 df1['iTempC'], df1['iTempD'],
                 df1['wSpedA'], df1['wSpedB'],
