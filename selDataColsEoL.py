...
def validCols(pParam):
    ...
    if pParam == 'T1':
        columns = [ # Tape Temperature --------------[]
                   'cLayer', 'R1H1TT', 'R1H2TT', 'R1H3TT', 'R1H4TT',
        ...
        columns = [# Substrate Temperature -----------[]
                   'cLayer', 'R1H1ST', 'R1H2ST', 'R1H3ST', 'R1H4ST',
        ...
        columns = [ # TAPE PLACEMENT --------------[]
                   'cLayer', 'R1H1TP', 'R1H2TP', 'R1H3TP', 'R1H4TP',
        ...
        columns = [ # Roller Force ----------------[]
                   'cLayer', 'R1H1RF', 'R1H2RF', 'R1H3RF', 'R1H4RF',
